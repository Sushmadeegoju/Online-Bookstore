...
INSERT INTO `book` (title, author, description, price, rating, is_public, is_featured, category_id) VALUES ('Mohandas K Ghandi: Autobiography', 'Mahatma Gandhi', '', 599, 0, FALSE, FALSE, 1004);
